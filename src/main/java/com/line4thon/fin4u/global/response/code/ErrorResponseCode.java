...
public enum ErrorResponseCode implements BaseResponseCode {
    ...
    BAD_REQUEST_ERROR("GLOBAL_400_1", BAD_REQUEST, "잘못된 요청 방식입니다."),
    INVALID_HTTP_MESSAGE_BODY("GLOBAL_400_2", BAD_REQUEST, "HTTP RequestBody의 형식이 잘못되었습니다."),
    ...
    NOT_FOUND_ENDPOINT("GLOBAL_404", NOT_FOUND, "존재하지 않는 endpoint입니다. path를 확인해주세요"),
